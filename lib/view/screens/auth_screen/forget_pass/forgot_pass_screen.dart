          ...
          children: [
            ...
            RichText(
                ...
                text: TextSpan(children: [
                  TextSpan(
                      text: AppString.forgetYour,
                      style: CustomTextStyle.h1(color: AppColor.black)),
                  TextSpan(
                      text: AppString.forgotYourPass,
                ...
                child: Padding(
                  ...
                  child: CustomTextField(
                    ...
                    textEditingController:
                        forgotPassController.emailController.value,
            ...
            CustomBodyBtn(
                title: AppString.getVerifyCode,
                ontap: () {
                  if (formKey.currentState!.validate()) {
                    Get.toNamed(AppRoute.forgotOtpVerifyScreen);
                  }
                }),
            SizedBox(
              height: 100.h,
